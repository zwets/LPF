...
function update_moss(argument){
    ...
    if (argument == 1) {
        var cmd = `~/anaconda3/bin/conda run -n base python3 /opt/moss/ubuntu_22_install.py -git`;
    } else if (argument == 2) {
        var cmd = `~/anaconda3/bin/conda run -n base python3 /opt/moss/ubuntu_22_install.py -light`;
    }
