...
def SurveillancePipeline(i_illumina, i_nanopore,
    ...
    if output_name[0] == "/":
        target_dir = db_dir + "preliminaryEstimations/" + output_name.split("/")[-1] + "/"
    else:
        target_dir = db_dir + "preliminaryEstimations/" + output_name + "/"
    ...
    best_template, best_template_score, template_found, header_text = moss.findTemplateSurveillance(total_filenames, target_dir, kma_database_path, logfile, kma_path)
...
def main():
    ...
    SurveillancePipeline(args.i_illumina, args.i_nanopore, db_dir, args.output_name, args.exepath)
