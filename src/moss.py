...
parser.add_argument('-version', action='version', version='moss 1.0.0', dest="version", help = "Current version of moss.")
...
def moss_pipeline(seqType, masking_scheme, prune_distance, bc,
                         db_dir, multi_threading, exepath, laptop, metadata, metadata_headers, version):
...
def main():
    moss_pipeline(args.seqType, args.masking_scheme, args.prune_distance, args.bc, args.db_dir, args.multi_threading, args.exepath, args.laptop, args.metadata, args.metadata_headers, args.version)
