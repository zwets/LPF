...
def SurveillancePipeline(input, seqType, masking_scheme, prune_distance, bc,
    ...
    if template_found == False: #NO TEMPLATE FOUND #Being assembly
        ...
        if assemblyType == "illumina":
            moss.inputAssemblyFunction(assemblyType, inputType, target_dir, input, illumina_name1, illumina_name2, "", jobid, inputname, kma_path, kma_database_path, entryid, referenceSyncFile, isolatedb, db_dir)
        elif assemblyType == "nanopore":
            moss.inputAssemblyFunction(assemblyType, inputType, target_dir, input, "", "", jobid, inputname, kma_path, kma_database_path, entryid, referenceSyncFile, isolatedb, db_dir)
...
def main():
    SurveillancePipeline(args.input, args.seqType, args.masking_scheme, args.prune_distance, args.bc, db_dir, args.multi_threading, args.exepath, args.coordinates, args.location)
