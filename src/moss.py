...
def moss_pipeline(config_name, metadata, metadata_headers):
    ...
    moss.kma_finders("-ont -md 5", "resfinder", target_dir, input, "/opt/moss/resfinder_db/all")
    moss.kma_finders("-ont -md 5", "virulencefinder", target_dir, input, "/opt/moss/virulencefinder_db/all")
    moss.kma_finders("-ont -md 5", "plasmidfinder", target_dir, input, "/opt/moss/plasmidfinder_db/all")
