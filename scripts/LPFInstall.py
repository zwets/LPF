...
def install_ont_deps():
    ...
    print (cmd)
    subprocess.call(cmd, stdout=open(file, 'a'))
    ...
    cmd = "sudo apt install ./kcri-apt-repo_1.0.0_all.deb".split()
    print (cmd)
    subprocess.call(cmd, stdout=open(file, 'a'))
    ...
    cmd = "sudo apt install kcri-seqtz-repos".split()
    print (cmd)
    subprocess.call(cmd, stdout=open(file, 'a'))
    ...
    subprocess.call(cmd, stdout=open(file, 'a'))
    #os.system("sudo apt update")
    cmd = "sudo apt install kcri-seqtz-deps".split()
    print (cmd)
    subprocess.call(cmd, stdout=open(file, 'a'))
    #os.system("sudo apt install kcri-seqtz-deps")
    cmd = "sudo apt install kcri-seqtz-ont".split()
    print (cmd)
    subprocess.call(cmd, stdout=open(file, 'a'))
