...
def build_app():
    ...
    os.system("cd local_app;sudo chmod a+x lpf_launch; npm i; ./node_modules/.bin/electron-rebuild; sudo npm run dist;sudo cp lpf.desktop /usr/share/applications/.; cd ..")
    return True
